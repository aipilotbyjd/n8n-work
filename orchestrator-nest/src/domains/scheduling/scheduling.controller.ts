...
export class SchedulingController {
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves upcoming scheduled executions within the specified time range.",
  })
  @ApiQuery({
    name: "hours",
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      "Permanently deletes a schedule and cancels pending executions.",
  })
  @ApiParam({ name: "id", description: "Schedule UUID" })
  ...
  async toggleSchedule(
    ...
    return this.schedulingService.toggleSchedule(
      id,
      isActive,
      tenantId,
      user.id,
  ...
  async triggerSchedule(
    ...
    return this.schedulingService.triggerScheduleManually(
      id,
      tenantId,
      user.id,
    );
  ...
  async getScheduleExecutions(
    ...
    return this.schedulingService.getScheduleExecutions(
      id,
      tenantId,
      limit,
      offset,
  ...
  @ApiOperation({
    ...
    description:
      "Validates a cron expression and returns the next execution times.",
  })
  @ApiOkResponse({
