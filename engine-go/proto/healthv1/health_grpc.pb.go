...
const (
	HealthService_Check_FullMethodName = "/n8nwork.health.v1.HealthService/Check"
	HealthService_Watch_FullMethodName = "/n8nwork.health.v1.HealthService/Watch"
	HealthService_Ready_FullMethodName = "/n8nwork.health.v1.HealthService/Ready"
	HealthService_Live_FullMethodName  = "/n8nwork.health.v1.HealthService/Live"
)
...
type HealthServiceClient interface {
	...
	Live(ctx context.Context, in *LivenessCheckRequest, opts ...grpc.CallOption) (*LivenessCheckResponse, error)
}
...
func (c *healthServiceClient) Ready(ctx context.Context, in *ReadinessCheckRequest, opts ...grpc.CallOption) (*ReadinessCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *healthServiceClient) Live(ctx context.Context, in *LivenessCheckRequest, opts ...grpc.CallOption) (*LivenessCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LivenessCheckResponse)
	err := c.cc.Invoke(ctx, HealthService_Live_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HealthServiceServer interface {
	...
	// Liveness check (service is alive)
	Live(context.Context, *LivenessCheckRequest) (*LivenessCheckResponse, error)
...
func (UnimplementedHealthServiceServer) Ready(context.Context, *ReadinessCheckRequest) (*ReadinessCheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Ready not implemented")
}
func (UnimplementedHealthServiceServer) Live(context.Context, *LivenessCheckRequest) (*LivenessCheckResponse, error) {
...
func _HealthService_Ready_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).Ready(ctx, req.(*ReadinessCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HealthService_Live_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthService_Live_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).Live(ctx, req.(*LivenessCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "n8nwork.health.v1.HealthService",
