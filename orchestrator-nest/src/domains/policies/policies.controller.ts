...
export class PoliciesController {
  ...
  async updatePolicy(
    ...
    return this.policiesService.updatePolicy(tenantId, policyId, updatePolicyDto, userId);
  }
  ...
  async getPolicies(@GetCurrentTenant() tenantId: string): Promise<PolicyResponseDto[]> {
